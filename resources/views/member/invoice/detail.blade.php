...
<div class="main-content container-fluid">
    <div class="row">
        ...
        <div class="col-md-3">
            ...
            <div class="mt-4">
                <h4>Actions</h4>
                <a href="{{ route('member.invoice.print', $invoice)}}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-download" viewBox="0 0 16 16">
